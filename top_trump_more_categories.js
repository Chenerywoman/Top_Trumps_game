...
populateCards(document.getElementsByClassName("card-pile")[0].getElementsByClassName("card")[0], witchesWizards);
document.getElementsByClassName("card-pile")[0].getElementsByClassName("number-of-cards")[0].innerHTML = witchesWizards.length;
...
shuffleButton.addEventListener("click", () => {
    ...
    for (i = 0; i < witchesWizards.length; i++) {
    ...
    if (playerTurn == 1) {
        ...
        playerTwoTopCard.style.color = "#9c1203";
        playerTwoTopCard.getElementsByTagName("img")[0].style.visibility = "hidden";

    } else {
        playerOneTopCard.style.color = "#9c1203";
        playerOneTopCard.getElementsByTagName("img")[0].style.visibility = "hidden";
    }
...
compareButton.addEventListener("click", () => {
    ...
    if (playerTurn == 1) {
        ...
        playerTwoTopCard.getElementsByTagName("img")[0].style.visibility = "visible";

    } else {
        playerOneTopCard.style.color = "#00165e";
        playerOneTopCard.getElementsByTagName("img")[0].style.visibility = "visible";
    }
    ...
    moveButton.addEventListener("click", () => {
        ...
        if (playerOne.length == witchesWizards.length || playerTwo.length == witchesWizards.length){
            ...
            showPlayer(roundWinner, document.getElementsByClassName("turn")[0].getElementsByTagName("span")[0]);
            showElements(document.getElementsByClassName("turn")[0]);
            showElements(document.getElementsByTagName("label")[0]);
            showElements(selectCategoriesMenu);
            showElements(compareButton);
